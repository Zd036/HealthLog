...
import com.example.heartcare.data.repository.MedicationRepository
import com.example.heartcare.data.repository.SettingsRepository
import com.example.heartcare.data.repository.VitalSignsRepository
import com.example.heartcare.worker.BackupScheduler
import com.example.heartcare.worker.MedicationReminderScheduler
...
class HeartCareApp : Application(), Configuration.Provider {
    ...
    override fun onCreate() {
        ...
        appScope.launch {
            ...
            MedicationReminderScheduler.rescheduleAll(this@HeartCareApp)
            // 启动每日备份任务（凌晨 2:00）
            BackupScheduler.scheduleDaily(this@HeartCareApp)
        }
    }
    ...
    companion object {
        ...
        lateinit var instance: HeartCareApp
            private set
    }
}
